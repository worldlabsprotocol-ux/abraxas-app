...
-- Forward-only correction for enqueue_partner_webhook_test_delivery advisory lock overload.
--
-- Prerequisite: 067_partner_webhook_test_event_atomic.sql (already applied in Production)
