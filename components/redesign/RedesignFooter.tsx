        ...
        <div style={{
          ...
          <div style={{ gridColumn: "span 1", minWidth: 180 }}>
            ...
            <p style={{
              ...
              Verify once. Transact everywhere. The RWA website for real world asset tokenization — reusable verification infrastructure for tokenized real-world assets.
            </p>
