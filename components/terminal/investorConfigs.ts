...
export const INVEST_CONFIGS: Record<string, AssetInvestConfig> = {
  ...
  "aas-4": {
    ...
    subtitle: "Smyrna, Georgia · Cumberland Townhomes · 6 min from Truist Park",
    color: "#06B6D4",
    stats: [
      { label: "Unit Type",       val: "2BD / 1.5BA Townhome" },
      ...
      { label: "Current Est. Value", val: "$208,200" },
    ],
    historicalNote:
      "Purchased in March 1999 for $76,200, public record confirmed. Current estimated value is $208,200, a 2.7x appreciation over 27 years. Located in the Cumberland Townhomes community in Smyrna's 30080 zip code, one of metro Atlanta's strongest residential markets following The Battery Atlanta development. Comparable units on the same street sold as recently as 2021 for $220,000, supporting this valuation range.",
    options: [
      {
        title: "Collateral Loan",
        badge: "RECOMMENDED",
      ...
      },
      {
        ...
        color: "#8B5CF6",
        desc: "Tokenize a defined percentage of equity as a Reg D offering. Investors earn proportional appreciation on future sale or refinance, paid in USDC.",
