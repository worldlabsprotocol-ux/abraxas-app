...
// Five-second homepage opener — headline left, story deck right on desktop.
      ...
      <div className="home-hero-grid">
        <div>
          ...
          <p style={{
            ...
            Proof for real-world assets on chain — in plain language.
          </p>
          ...
          <p style={{
            ...
            Abraxas helps people and assets carry reusable verification — so partners can ask a clear question and get a clear answer.
          </p>
          <p style={{
            fontFamily: FONT, fontSize: "0.82rem", color: "var(--text-secondary)",
            lineHeight: 1.65, maxWidth: 520, margin: "0 0 1.75rem",
          }}>
            You approve what gets shared. The policy engine returns approved, denied, or review — nothing hidden in a generic badge.
          </p>
