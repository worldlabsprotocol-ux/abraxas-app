...
// Signed-in product preview — compact Passport card, not a dashboard.
...
export function HomeSignedInModule() {
  ...
  const { walletBindingL3, setup } = usePassportVerification(suiAddress, email);
    ...
    <section style={{
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <Link href="/passport?tab=wallets" style={{
          ...
          {tierInput.walletBound ? "Manage wallets" : "Add wallet"} →
        </Link>
      </div>
