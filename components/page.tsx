...
//
// LIGHT-MODE FIX (June 2026): DarkPanel here used the exact same hex
// as the page background (#FAFAF8), so every section card had zero
// visual separation from the page itself, just a thin border. Switched
// to var(--surface) (white) so cards actually pop off the page, same
// as the DarkPanel in TerminalMain.tsx already does correctly.
...
function DarkPanel({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ background:"var(--surface, #FFFFFF)", borderRadius:16,
