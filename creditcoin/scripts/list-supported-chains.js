...
async function main() {
  const rpcUrl = process.env.CREDITCOIN_RPC_URL || "https://rpc.usc-testnet.creditcoin.network";
  const rpc = new ethers.JsonRpcProvider(rpcUrl, 102033, { staticNetwork: true });
