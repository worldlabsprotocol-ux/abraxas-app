...
export const ASSURANCE_NETWORK_TRUST_POINTS = [
  ...
  "Partner policy determines what proof is acceptable. Authentication begins the journey and authoritative evidence establishes eligibility.",
  "Transaction time ID requirements are policy obligations. They are not stronger identity evidence.",
] as const;
...
export const ASSURANCE_NETWORK_USE_CASES = [
  ...
  },
  {
    ...
    body: "Humanity and abuse resistance signals are separate from government ID age proof.",
  },
  {
...
export const ASSURANCE_NETWORK_DISCLAIMER =
  "Abraxas does not replace legally required physical, point of sale, pickup, or delivery ID checks. Google sign in establishes account authentication. It does not establish a person's age. Example policies shown for architecture illustration are not legal approval or production certification.";
