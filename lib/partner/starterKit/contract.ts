...
export const STARTER_KIT_VERSION = "1.10.0" as const;
...
export const STARTER_KIT_PLATFORM_MATRIX = [
  ...
  },
  {
    ...
    runtime: "typescript_serverless",
    canonical: false,
    works: ["solana_gate", "hosted_partner_flow", "server_receipt_verify", "webhook_events", "onchain_protocol_gate", "solana_onchain_eligibility_gate", "eligibility_presentation", "cross_chain_protocol_access"],
  ...
  },
  {
    ...
    runtime: "typescript_serverless",
    canonical: false,
    works: ["onchain_protocol_gate", "evm_onchain_eligibility_gate", "evm_partner_adapter", "hosted_partner_flow", "server_receipt_verify", "eligibility_presentation", "cross_chain_protocol_access"],
  ...
  },
  {
    ...
    runtime: "typescript_serverless",
    canonical: false,
    works: ["onchain_protocol_gate", "solana_onchain_eligibility_gate", "solana_gate", "hosted_partner_flow", "server_receipt_verify", "eligibility_presentation", "cross_chain_protocol_access"],
