...
export const STARTER_KIT_VERSION = "1.12.0" as const;
...
export const PATH_IMPLIED_CAPABILITY: Record<IntegrationStudioPathId, string> = {
  ...
  cross_chain_protocol_access: "cross_chain_protocol_access",
  testnet_gate_deployment: "testnet_gate_deployment",
  institutional_eligibility_gate: "institutional_eligibility_gate",
};
...
export const STARTER_KIT_PLATFORM_MATRIX = [
  ...
  },
  {
    ...
    runtime: "typescript_serverless",
    canonical: false,
    works: ["solana_gate", "hosted_partner_flow", "server_receipt_verify", "webhook_events", "onchain_protocol_gate", "solana_onchain_eligibility_gate", "eligibility_presentation", "cross_chain_protocol_access", "testnet_gate_deployment"],
  ...
  },
  {
    ...
    runtime: "typescript_serverless",
    canonical: false,
    works: ["onchain_protocol_gate", "evm_onchain_eligibility_gate", "evm_partner_adapter", "hosted_partner_flow", "server_receipt_verify", "eligibility_presentation", "cross_chain_protocol_access", "testnet_gate_deployment"],
  ...
  },
  {
    ...
    runtime: "typescript_serverless",
    canonical: false,
    works: ["onchain_protocol_gate", "solana_onchain_eligibility_gate", "solana_gate", "hosted_partner_flow", "server_receipt_verify", "eligibility_presentation", "cross_chain_protocol_access", "testnet_gate_deployment"],
