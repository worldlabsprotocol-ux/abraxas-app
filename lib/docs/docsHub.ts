    ...
    topics: [
      {
        ...
        links: [
          ...
          { label: "Chain-verifiable attestations", href: "/docs/chain-verifiable-attestations" },
          { label: "Solana onchain eligibility gate", href: "/docs/solana-onchain-eligibility-gate" },
          { label: "EVM onchain eligibility gate", href: "/docs/evm-onchain-eligibility-gate" },
          { label: "Verified onchain gate deployments", href: "/docs/onchain-gate-deployments" },
          { label: "Chain attestation signer lifecycle", href: "/docs/chain-attestation-signer-lifecycle" },
          ...
          { label: "Reclaim private attestations", href: "/docs/reclaim-private-attestations" },
          { label: "Eligibility presentation protocol", href: "/docs/eligibility-presentation-protocol" },
          { label: "Cross-chain protocol access", href: "/docs/cross-chain-protocol-access" },
          { label: "Testnet gate deployment kit", href: "/docs/testnet-gate-deployment" },
          { label: "Onchain verifier conformance", href: "/docs/onchain-verifier-conformance" },
          { label: "Organization eligibility", href: "/docs/organization-eligibility" },
    ...
    topics: [
      {
        ...
        links: [
          ...
          { label: "Onchain verifier conformance", href: "/docs/onchain-verifier-conformance" },
          { label: "Organization eligibility", href: "/docs/organization-eligibility" },
          { label: "Hosted Partner Flow handoff", href: "/docs/hosted-partner-flow-handoff" },
          { label: "Partner Flow", href: "/docs/partner-flow" },
