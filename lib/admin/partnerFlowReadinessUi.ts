...
const PREFLIGHT_LABELS: Record<string, string> = {
  ...
  return_url_syntax_valid: "Return URL uses valid HTTPS syntax",
  ...
  return_url_request_allowlisted: "Return URL is allowlisted for the partner",
  all_stored_return_urls_compliant: "All stored return URLs are production compliant",
  policy_row_exists: "Policy family exists",
  policy_active: "Exactly one active policy version exists",
  policy_partner_match: "Active policy belongs to the partner",
  policy_assigned_match: "Assigned policy matches submitted policy",
