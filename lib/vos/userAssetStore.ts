...
export const STAGE_META: Record<LifecycleState, {
  ...
  MINTED:             { label:"Asset Minted",             shortLabel:"Minted",         color:"#20DCA5", verifier:"Solana Network",          description:"Tokens issued on Solana mainnet under SPL Token-2022",        progressPct:97, requiredDocs:[], aiNote:"Mint confirmed on-chain. Token-2022 standard. AAS-1 attestation anchored." },
