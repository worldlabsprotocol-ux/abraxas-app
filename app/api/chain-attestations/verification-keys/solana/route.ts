// FILE: app/api/chain-attestations/verification-keys/solana/route.ts
// Public Solana chain-attestation signer document. No private material.
...
export async function GET(req: NextRequest) {
  ...
  const document = buildChainAttestationSignerDocument({ algorithm: "ed25519" });
