    ...
    <RedesignPage maxWidth={820}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.625rem", marginBottom: "2rem" }}>
        ...
        <a href={`https://solscan.io/token/${TOKENOMICS.contract}`} target="_blank" rel="noopener noreferrer"
          style={{ padding: "0.75rem 1.35rem", borderRadius: 999, border: "1px solid var(--border)",
                    color: "var(--text-primary)", fontFamily: FONT, fontSize: "0.82rem",
                    fontWeight: 600, textDecoration: "none" }}>
          View on Solscan →
        </a>
        <Link href="/docs" style={{ padding: "0.75rem 1.35rem", borderRadius: 999,
          border: "1px solid var(--border)", color: ACCENT, fontFamily: FONT,
