      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          <div className="bg-bg-2 border border-border rounded-card p-4 text-center">
            ...
            <div className="text-[0.65rem] text-abraxas-subtle uppercase tracking-wider">Events Triggered</div>
          </div>
          <div className="bg-bg-2 border border-border rounded-card p-4 text-center">
            <div className="font-display font-bold text-2xl text-abraxas-green mb-1">
              {formatCurrency(totalPreserved)}
            </div>
            <div className="text-[0.65rem] text-abraxas-subtle uppercase tracking-wider">Capital Preserved</div>
          </div>
          <div className="bg-bg-2 border border-border rounded-card p-4 text-center">
            <div className="font-display font-bold text-2xl text-abraxas-green mb-1">$0</div>
            <div className="text-[0.65rem] text-abraxas-subtle uppercase tracking-wider">Unrecovered</div>
          </div>
        </div>
      </div>
      <DefenseFeed />
