    ...
    <div style={{ background: "var(--void)" }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          height: "900px",
          borderRadius: "50%",
          border: "1px solid rgba(107,140,255,0.04)",
          top: "50%",
          left: "50%",
          transform: "translate(-50%, -50%)",
          pointerEvents: "none",
        ...
        <div style={{ maxWidth: "760px", position: "relative", zIndex: 2 }}>
            ...
            {[
              ...
              <div key={p.n} style={{ textAlign: "center" }}>
                <div style={{
                  ...
                  fontSize: p.active ? "1.5rem" : "1rem",
                  color: p.active ? "var(--gold)" : "var(--subtle)",
                  fontStyle: "italic",
                  transition: "all 0.3s",
                }}>
                  {p.n}
                ...
                {p.active && (
                  <div style={{ width: "100%", height: "1px", background: "var(--gold)", marginTop: "4px", boxShadow: "0 0 8px var(--gold)" }} />
                )}
              </div>
            ))}
          </div>
          ...
          <p style={{
            ...
            defended by real-time circuit protection,
            settling on Solana.
          </p>

          <div style={{ display: "flex", gap: "0.875rem", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/app">
              <Button size="lg">Enter the System</Button>
            </Link>
            <Link href="/live">
              <Button size="lg" variant="ghost">Live Performance</Button>
            </Link>
          </div>
        </div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem", textAlign: "center" }}>
          {[
            ...
            <div key={s.label}>
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: "1.4rem", color: "var(--text)" }}>
                {s.value}
              </div>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "6rem 1.5rem" }}>
        <div style={{ marginBottom: "3rem" }}>
          <div style={{ fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--subtle)", marginBottom: "1rem" }}>
            Architecture
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1px", background: "var(--line)" }}>
          {[
            ...
            >
              <div style={{ fontFamily: "'Instrument Serif', serif", fontSize: "3rem", color: "var(--subtle)", fontStyle: "italic", marginBottom: "1.25rem", lineHeight: 1 }}>
                {s.n}
              </div>
              <div style={{ fontSize: "1.25rem", marginBottom: "0.75rem" }}>{s.icon}</div>
              <div style={{ fontWeight: 600, fontSize: "0.95rem", marginBottom: "0.5rem", color: "var(--text)" }}>
                {s.title}
              </div>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 1.5rem 8rem" }}>
        <div style={{
          ...
          <div style={{
            ...
            background: "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(200,169,110,0.06), transparent)",
            pointerEvents: "none",
          }} />
      ...
      <div style={{ borderTop: "1px solid var(--line)", padding: "1.25rem", textAlign: "center", background: "var(--deep)" }}>
        <p style={{ fontSize: "0.7rem", color: "var(--subtle)", letterSpacing: "0.05em" }}>
          {ABRA.ticker} &nbsp;·&nbsp; Solana &nbsp;·&nbsp;{" "}
          <a href={ABRA.solscan} target="_blank" rel="noopener noreferrer" style={{ color: "var(--gold)", textDecoration: "none", fontFamily: "'JetBrains Mono', monospace", fontSize: "0.65rem" }}>
            {ABRA.caShort}
          </a>
          &nbsp;·&nbsp;
          <a href={ABRA.bags} target="_blank" rel="noopener noreferrer" style={{ color: "var(--gold)", textDecoration: "none" }}>
            Trade on Bags
          </a>
          &nbsp;·&nbsp;
          <a href={ABRA.dexscreener} target="_blank" rel="noopener noreferrer" style={{ color: "var(--gold)", textDecoration: "none" }}>
            Chart
          </a>
        </p>
      </div>
