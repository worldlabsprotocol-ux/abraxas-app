// FILE: app/page.tsx — branded splash, auto-redirects to /auth/signin
"use client";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const r = setTimeout(() => router.push("/auth/signin"), 2400);
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign:"center", marginBottom:"3rem" }}>
        ...
        <div style={{
          fontSize:"clamp(0.36rem,1.2vw,0.52rem)", fontWeight:700,
